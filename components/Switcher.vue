<template>
    <div>
        <a href="#" @click="scrollToTop" v-show="showTopButton" id="back-to-top" class="fixed text-lg rounded-full z-10 bottom-5 right-5 size-9 text-center bg-primary text-white leading-9"><i class="mdi mdi-arrow-up"></i></a>
        <!-- Back to top -->
