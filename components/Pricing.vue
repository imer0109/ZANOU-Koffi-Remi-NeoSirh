                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    <div class="group p-6 relative overflow-hidden shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 rounded-md h-fit">
                        ...
                        <ul class="list-none text-slate-400">
                            <li class="mb-1 ms-0 flex"><i class="mdi mdi-check-circle-outline text-teal-500 text-[20px] align-middle me-2"></i> <span>We offers a free month of service for new customers.</span></li>
                        </ul>
                    ...
                    <div class="group p-6 relative overflow-hidden shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 rounded-md h-fit">
                        ...
                        <ul class="list-none text-slate-400">
                            <li class="mb-1 ms-0 flex"><i class="mdi mdi-check-circle-outline text-teal-500 text-[20px] align-middle me-2"></i> <span>We offers a free 7 days of service for new customers.</span></li>
                            <li class="mb-1 ms-0 flex"><i class="mdi mdi-check-circle-outline text-teal-500 text-[20px] align-middle me-2"></i> <span>Our Talented & Experienced Marketing Agency</span></li>
                        </ul>
